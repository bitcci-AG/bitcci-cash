...
contract('ERC20', function (accounts) {
  ...
  const cap = new BN(1000000);
  const decimals = new BN(2);

  beforeEach(async function () {
   // this.token = await bitcciCash.new(name, symbol, initialHolder, initialSupply);
    this.token = await bitcciCash.new(name, symbol,decimals, cap, { from: initialHolder });
